...
public class ProfileDigester {
	...
	/***
	 * Generates MD5 digest byte array for a given item.  Digest is generated by digesting values yielded by the
	 * metadata profile associated with this instance for the given item and optionally the item's content text.
	...
	/***
	 * Generates MD5 digest hex string for a given item.  Digest is generated by digesting values yielded by the
	 * metadata profile associated with this instance for the given item and optionally the item's content text.
